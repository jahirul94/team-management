...
const ViewTeam = () => {
    return (
        <div className="border border-indigo-400 bg-[#F4F1F2] p-10 rounded-lg my-10">
            <div className="pb-4">
                <p className="text-center font-bold text-3xl text-slate-500">Welcome to the team!</p>
                <p className="text-center font-semibold text-xl text-slate-500">there are some things for you to get started</p>
            </div>
            <div className="my-8 flex justify-around items-center space-x-4">
